...
func TestRoute(t *testing.T) {
	...
	chall := test_utils.CreateChallenge(t, "chall", "cat", "test-desc", sqlc.DeployTypeStatic, 1, sqlc.ScoreTypeDynamic)
	...
	chall_no_flag := test_utils.CreateChallenge(t, "chall-no-flag", "cat", "test-desc", sqlc.DeployTypeStatic, 1, sqlc.ScoreTypeDynamic)
